...
-- World data by PlaceId (+3 studs higher on Y)
local Worlds = {
	[102553576537621] = { -- W1
		WinCFrame = CFrame.new(-6510.71289, 269.467041, -15756.5098, 0, 0, 1, 0, 1, -0, -1, 0, 0),
	},
	[77764718018334] = { -- W2
		WinCFrame = CFrame.new(-32654.9492, -1759.86194, 50200.6875, 0, 0, -1, 0, 1, 0, 1, 0, 0),
	},
	[109451440978523] = { -- W3
		WinCFrame = CFrame.new(-27238.2129, 1656.729, 76626.0234, 0, 0, -1, 0, 1, 0, 1, 0, 0),
	},
}

-- Detect world by PlaceId
local function DetectWorld()
	local World = Worlds[game.PlaceId]
	if World then
		return World
	end
	return nil
...
-- AUTO WINS: Detect world by PlaceId -> Teleport to WinCFrame
local function DoAutoWin()
	...
	pcall(function()
		...
		if not World then
			warn("Unknown PlaceId: " .. tostring(game.PlaceId))
			return
		end
...
FeaturesBox:AddLabel({ Text = '<font color="#60d888">Auto Buy All Trail</font>' })
FeaturesBox:AddLabel({ Text = '<font color="#60d888">Auto Buy All Aura</font>' })
