...
local TrainPositions = {
	[0] = CFrame.new(74.4851074, 2.64575958, 50751.6875, -1.1920929e-07, 0, 1.00000012, 0, 1, 0, -1.00000012, 0, -1.1920929e-07) * CFrame.Angles(0, math.pi, 0) + Vector3.new(0, 3, 0),
	[1] = CFrame.new(74.6634521, 2.6457634, 50765.6875, -1.1920929e-07, 0, 1.00000012, 0, 1, 0, -1.00000012, 0, -1.1920929e-07) * CFrame.Angles(0, math.pi, 0) + Vector3.new(0, 3, 0),
	[3] = CFrame.new(74.6634521, 2.6457634, 50779.6875, -1.1920929e-07, 0, 1.00000012, 0, 1, 0, -1.00000012, 0, -1.1920929e-07) * CFrame.Angles(0, math.pi, 0) + Vector3.new(0, 3, 0),
}
