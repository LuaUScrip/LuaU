...
FeaturesBox:AddLabel({ Text = '<font color="#60d888">✓ Fast Throw</font>' })
FeaturesBox:AddLabel({ Text = '<font color="#60d888">✓ VIP Mode</font>' })
FeaturesBox:AddLabel({ Text = '<font color="#60d888">✓ Boost Mode</font>' })
